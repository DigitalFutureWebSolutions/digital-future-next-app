                                                ...
                                                <ul className="category-list">
                                                    ...
                                                    {serviceData && serviceData.blogs && serviceData.blogs.length > 0 ? (
                                                        serviceData.blogs.map((item, index) => (
                                                            <li key={index} className={item.slug === data.blog.slug ? "active" : ""}><Link href={`/service/${item.slug}`}><i className="fa-sharp fa-regular fa-arrow-right"></i>{item.title} </Link></li>
                                                        ))
                                                    ) : (
                                                        <li></li>
                                                    )}
